...
public class GifReflectArrayAdapter extends ArrayAdapter<String> {
    ...
    public GifReflectArrayAdapter(Context context) {
        super(context, R.layout.ten_list_view_item, new ArrayList<String>());
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (rowView == null) {
            ...
            rowView = inflater.inflate(R.layout.ten_list_view_item, parent, false);
