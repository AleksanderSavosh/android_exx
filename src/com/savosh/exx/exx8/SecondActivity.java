...
import com.savosh.exx.exx8.model.ExchangeRateDiv;
...
public class SecondActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.exx8_second_activity);
    ...
    public class CurrencyInfoAdapter extends ArrayAdapter<ExchangeRateDiv> {
        ...
        public CurrencyInfoAdapter(Context context, List<ExchangeRateDiv> values) {
            super(context, R.layout.exx8_second_card_view, values);
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (rowView == null) {
                ...
                rowView = inflater.inflate(R.layout.exx8_second_card_view, parent, false);
