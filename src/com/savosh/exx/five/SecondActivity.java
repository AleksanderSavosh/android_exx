...
public class SecondActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.five_second_activity);

        loginView = findViewById(R.id.five_second_activity_login_layout);
        catsView = View.inflate(this, R.layout.three_first_activity, null);
    ...
    public void click(View v){
        switch (v.getId()){
            ...
            case R.id.three_first_activity_btn_add:{
                new com.savosh.exx.three.FirstActivity.DownloadImageTask(this, catsLayout).execute();
            }
        }
    }
